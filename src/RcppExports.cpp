...
RcppExport SEXP _HydroGallery_RcppExport_registerCCallable() { 
    ...
    R_RegisterCCallable("HydroGallery", "_HydroGallery_confluen_WaterGAP3U", (DL_FUNC)_HydroGallery_confluen_WaterGAP3U_try);
    R_RegisterCCallable("HydroGallery", "_HydroGallery_confluen_WaterGAP3N", (DL_FUNC)_HydroGallery_confluen_WaterGAP3N_try);
